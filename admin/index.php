...
if ($iaView->getRequestType() == iaView::REQUEST_HTML) {
    if ($pageAction == iaCore::ACTION_EDIT) {
        ...
        if (isset($_POST['save'])) {
            ...
            $insert['status'] = in_array($insert['status'],
                array(iaCore::STATUS_ACTIVE, iaCore::STATUS_INACTIVE)) ? $insert['status'] : 'inactive';
        ...
        $iaView->grid('_IA_URL_modules/comments/js/admin/comments');
    }
}
