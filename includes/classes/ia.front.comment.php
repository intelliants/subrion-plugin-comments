...
class iaComment extends abstractModuleFront
{
    ...
    {
        $map = array(
            ':)' => '<img alt=":)" src="' . IA_CLEAR_URL . 'modules/comments/templates/front/img/smiles/smile.png">',
            '=)' => '<img alt="=)" src="' . IA_CLEAR_URL . 'modules/comments/templates/front/img/smiles/smile.png">',
            ':(' => '<img alt=":(" src="' . IA_CLEAR_URL . 'modules/comments/templates/front/img/smiles/sad.png">',
            '=(' => '<img alt="=(" src="' . IA_CLEAR_URL . 'modules/comments/templates/front/img/smiles/sad.png">',
            ':D' => '<img alt=":D" src="' . IA_CLEAR_URL . 'modules/comments/templates/front/img/smiles/happy.png">',
        );
